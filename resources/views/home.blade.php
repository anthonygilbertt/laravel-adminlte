    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <ul>
          ...
          <a href="#" class="add-modal"><li>Add a truck</li></a>
        </ul>
      </div>
            ...
            @foreach($trucks as $truck)
              <tr class="item{{$truck->id}}
                ...
                <td class="text-center"><input type="checkbox" class="published" data-id="{{$truck->id}}"
                  ...
                  <td>
                    <button class="show-modal btn btn-success" data-id="{{$truck->id}}" data-seats="{{$truck->seats}}" data-weight_capacity="{{$truck->weight_capacity}}" data-make="{{$truck->make}}" data-model="{{$truck->model}}" data-year="{{$truck->year}}">
                      <span class="glyphicon glyphicon-eye-open"></span> Show</button>
                      <button class="edit-modal btn btn-info" data-id="{{$truck->id}}" data-seats="{{$truck->seats}}" data-weight_capacity="{{$truck->weight_capacity}}" data-make="{{$truck->make}}" data-model="{{$truck->model}}" data-year="{{$truck->year}}">
                        <span class="glyphicon glyphicon-edit"></span> Edit</button>
                        <button class="delete-modal btn btn-danger" data-id="{{$truck->id}}" data-seats="{{$truck->seats}}" data-weight_capacity="{{$truck->weight_capacity}}" data-make="{{$truck->make}}" data-model="{{$truck->model}}" data-year="{{$truck->year}}">
              ...
              <div class="modal-body">
                <form class="form-horizontal" role="form">
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="title">Seats:</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="content">Weight Capacity:</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="content">Gas Mileage:</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" id="content_add" cols="40" rows="5"></textarea>
                      <small>Min: 2, Max: 128, only text</small>
                      <p class="errorContent text-center alert alert-danger hidden"></p>
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="content">Make:</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" id="content_add" cols="40" rows="5"></textarea>
                      <small>Min: 2, Max: 128, only text</small>
                      <p class="errorContent text-center alert alert-danger hidden"></p>
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="content">Model:</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" id="content_add" cols="40" rows="5"></textarea>
                      <small>Min: 2, Max: 128, only text</small>
                      <p class="errorContent text-center alert alert-danger hidden"></p>
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="content">Year:</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" id="content_add" cols="40" rows="5"></textarea>
                      <small>Min: 2, Max: 128, only text</small>
                      <p class="errorContent text-center alert alert-danger hidden"></p>
        ...
        <div id="showModal" class="modal fade" role="dialog">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="form-horizontal" role="form">b
                  <div class="form-group">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="title">Weight Capacity:</label>
                    <div class="col-sm-10">
                      <input type="name" class="form-control" id="title_delete" disabled>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="title">Gas Mileage:</label>
                    <div class="col-sm-10">
                      <input type="name" class="form-control" id="title_delete" disabled>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="title">Make:</label>
                    <div class="col-sm-10">
                      <input type="name" class="form-control" id="title_delete" disabled>
                    </div>
                  </div>
